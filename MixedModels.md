...
- **Bradley-Terry models**: The Bradley-Terry model can be parameterized as a special case of the [GLMM with multiple membership](#multimembership-models). `r github("jvparidon/lmerMultiMember")` provides convenience functions for expressing the Bradley-Terry model.
