...
- **Bradley-Terry models**: The Bradley-Terry model can be parameterized as a special case of the GLMM with multiple membership and fitted with `r github("jvparidon/lmerMultiMember")`.
